...
// ==== Modul: ANIMALS ====
  ...
  function showAnimalsReward(imgSrc) {
    // Erst alles bisherige außer Videocontainer und Progress entfernen
    ...
    reward.style.top = "15vh"; // etwas höher als Mitte
    ...
    setTimeout(() => {
      ...
      // Button UNTER dem Container, mittig platzieren
