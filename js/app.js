...
document.body.appendChild(videoBox);
  ...
  if (i === s.correct) {
    ...
    btn.classList.add("shake");
    setTimeout(() => btn.classList.remove("shake"), 600);
    // Keine Buttons deaktivieren, kein Overlay – der Nutzer kann weiter klicken!
  }
}
